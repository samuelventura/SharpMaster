...
{
	partial class WriteRegisterControl
	{
		/// <summary>
		...
		private System.Windows.Forms.NumericUpDown numericUpDownRegisterValue;
		...
		private void InitializeComponent()
		{
			...
			this.numericUpDownRegisterValue = new System.Windows.Forms.NumericUpDown();
			...
			((System.ComponentModel.ISupportInitialize)(this.numericUpDownRegisterValue)).BeginInit();
			...
			// 
			this.numericUpDownRegisterValue.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.numericUpDownRegisterValue.Location = new System.Drawing.Point(224, 17);
			this.numericUpDownRegisterValue.Maximum = new decimal(new int[] {
			65535,
			0,
			0,
			0});
			this.numericUpDownRegisterValue.Name = "numericUpDownRegisterValue";
			this.numericUpDownRegisterValue.Size = new System.Drawing.Size(68, 20);
			this.numericUpDownRegisterValue.TabIndex = 20;
			// 
			// label1
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.numericUpDownRegisterValue, 3, 1);
			...
			this.Name = "WriteRegisterControl";
			this.Size = new System.Drawing.Size(372, 44);
			((System.ComponentModel.ISupportInitialize)(this.numericUpDownRegisterValue)).EndInit();
